...
LLDB is a next generation, high-performance debugger. It is built as a set of reusable components which helps you solve various debugging problems.
...
# Debug a process
lldb --wait-for --attach-pid 1234
# Debug a program
lldb --wait-for -- /path/to/program
# Debug a program with arguments
lldb --wait-for -- /path/to/program arg1 arg2
```

## Resources

- [LLDB](https://lldb.llvm.org/)
- [LLDB User Guide](https://lldb.llvm.org/use/index.html)
- [LLDB Command Reference](https://lldb.llvm.org/use/map.html)
- [LLDB Python API Reference](https://lldb.llvm.org/python-reference.html)
- [LLDB Python API Tutorial](https://lldb.llvm.org/python_tutorial.html)
- [LLDB Python API Examples](https://lldb.llvm.org/python_examples.html)
- [LLDB Python API Cookbook](https://lldb.llvm.org/python_cookbook.html)
