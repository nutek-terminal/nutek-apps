...
- [Arachni User Guide](https://github.com/Arachni/arachni/wiki/Command-line-user-interface)
...
Usage: /home/neosb/arachni-1.6.1.3-0.6.1.1/bin/../.system/arachni-ui-web/bin/arachni [options] URL
...
Scope
      ...
      --scope-dom-event-inheritance-limit LIMIT
...
Audit
      ...
      --audit-nested-cookies  Audit nested cookies.
...
HTTP
      --http-user-agent USER_AGENT
                              Value for the 'User-Agent' HTTP request header.
                                (Default: Mozilla/5.0 (Gecko) Arachni/v1.6.1.3)
...
Browser cluster
      ...
      --browser-cluster-session-storage FILE
      ...
      --browser-cluster-wait-for-timers
